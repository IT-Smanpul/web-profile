...
<html class="scroll-smooth" data-theme="light" data-assets-path="../assets/" data-layout-path="free-landing-page/"
  lang="en" dir="ltr">
  <head>
    <meta charset="utf-8" />
    <meta name="viewport"
  ...
  <body>
    ...
    <div class="bg-base-100">
          ...
          <div class="w-full lg:flex lg:items-center lg:gap-2">
                ...
                <span class="text-primary">
                  <svg width="32" height="32" viewBox="0 0 34 34" fill="none"
                    ...
                    <g clip-path="url(#clip0_18078_104881)">
                      <mask id="mask0_18078_104881" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0"
                        width="34" height="34">
                        <path
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_18078_104881" x1="30.2812" y1="2.65625" x2="4.25"
                        y2="32.4063" gradientUnits="userSpaceOnUse">
                        <stop offset="0" stop-color="currentColor" />
                        <stop offset="1" stop-color="currentColor" />
                      </linearGradient>
                      <linearGradient id="paint1_linear_18078_104881" x1="17.1147" y1="8.08008" x2="17.1147"
                        y2="25.0692" gradientUnits="userSpaceOnUse">
                        <stop offset="0" stop-color="white" />
                        <stop offset="1" stop-color="white" stop-opacity="0.6" />
                      </linearGradient>
                      <linearGradient id="paint2_linear_18078_104881" x1="17.0002" y1="-0.000447931" x2="17.0002"
                        y2="33.9996" gradientUnits="userSpaceOnUse">
            ...
            <div
              ...
              <div class="text-base-content flex gap-6 text-base max-lg:mt-4 max-lg:flex-col lg:items-center">
                <a class="hover:text-primary nav-link" href="#home">Home</a>
                <a class="hover:text-primary nav-link" href="#about-us">About Us</a>
                <a class="hover:text-primary nav-link" href="#services">Services</a>
                <a class="hover:text-primary nav-link" href="#team">Team</a>
                <a class="hover:text-primary nav-link" href="#faqs">FAQS</a>
              </div>
            </div>
      ...
      <main>
          ...
          <div
            ...
            <div
              ...
              <h1
                ...
                <span>Savor Every Bite. Savor<br />Every Moment.</span>
                <svg class="-z-1 left-25 absolute -bottom-1.5 max-lg:left-4 max-md:hidden"
                  xmlns="http://www.w3.org/2000/svg" width="348" height="10" viewBox="0 0 348 10"
                  fill="none">
                  <path
                  ...
                  <defs>
                    <linearGradient id="paint0_linear_17052_181397" x1="29.7873" y1="1.85626" x2="45.2975"
                      ...
                      <stop stop-color="var(--color-primary)" offset="1" />
                      <stop offset="1" stop-color="var(--color-primary-content)" />
                    </linearGradient>
                  </defs>
                </svg>
              </h1>
              <p class="text-base-content/80 max-w-3xl">Welcome to a dining experience where flavor, freshness, and
                hospitality come together. Whether it's your first visit or your hundredth, every plate is made to
                impress.</p>
            ...
            <img class="min-h-67 w-full object-cover" src="{{ asset('img/dishes-hero.png') }}" alt="Dishes" />
          </div>
        </section>
        <!-- About us -->
        <section id="about-us">
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div class="flex flex-col gap-12 md:gap-16 lg:gap-24">
                ...
                <div class="space-y-4 text-center">
                  ...
                  <p class="text-base-content/80 text-xl">Our achievement story stands as a powerful testament to
                    teamwork and perseverance. United, we have faced challenges, celebrated victories, and woven a
                    narrative of growth and success.</p>
                  <a class="btn btn-primary btn-lg btn-gradient" href="#">
                    Read More
                    <span class="icon-[tabler--arrow-right] size-5 rtl:rotate-180"></span>
                  </a>
                </div>
          ...
          <div class="bg-base-100 py-8 sm:py-16 lg:py-24">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div class="mb-12 space-y-4 text-center sm:mb-16 lg:mb-24">
                <h2 class="text-base-content text-2xl font-semibold md:text-3xl lg:text-4xl">Crafting Moments, Serving
                  You</h2>
                <p class="text-base-content/80 text-xl">From unforgettable flavors to seamless service, we’re here to
                  make every meal feel special. Whether you dine in, take out, or order online we’ve got your cravings
                  covered.</p>
              </div>
              <!-- Blog Grid -->
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="card card-border shadow-none">
                  <figure>
                    <img src="{{ asset('img/free-blog-1.png') }}" alt="Vegetable Market" />
                  </figure>
                  <div class="card-body gap-3">
                    <h5 class="card-title text-xl">Buffet Service</h5>
                    <p class="mb-5">Navigate effortlessly with our intuitive design, optimized for all devices. Enjoy
                      a seamless experience whether you're on a computer or mobile device.</p>
                ...
                <div class="card card-border shadow-none">
                  <figure>
                    <img src="{{ asset('img/free-blog-2.png') }}" alt="Delivery Service" />
                  </figure>
                  <div class="card-body gap-3">
                    <h5 class="card-title text-xl">Food delivery</h5>
                    <p class="mb-5">Enjoy a safe shopping experience with multiple payment options and SSL
                      encryption. Your personal and financial information is always protected.</p>
                    <div class="card-actions">
                      <a class="btn btn-primary btn-gradient" href="#">
                        Read More
                        <span class="icon-[tabler--arrow-right] size-5 rtl:rotate-180"></span>
                ...
                <div class="card card-border shadow-none">
                  <figure>
                    <img src="{{ asset('img/free-blog-3.png') }}" alt="Cafeteria" />
                  </figure>
                  <div class="card-body gap-3">
                    <h5 class="card-title text-xl">Cafeteria</h5>
                    <p class="mb-5">Find products quickly with advanced filters, sorting options, and suggestion.
                      Save time and effortlessly locate exactly what you need with ease.</p>
                    <div class="card-actions">
                      <a class="btn btn-primary btn-gradient" href="#">
                        Read More
                        <span class="icon-[tabler--arrow-right] size-5 rtl:rotate-180"></span>
        ...
        <div class="bg-base-200 py-8 sm:py-16 lg:py-24">
          <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="relative flex w-full gap-12 max-lg:flex-col md:gap-16 lg:items-center lg:gap-24"
              id="multi-slide" data-carousel='{ "loadingClasses": "opacity-0", "slidesQty": { "xs": 1, "md": 2 } }'>
              <div>
                <div class="space-y-4">
                  <h2 class="text-base-content text-2xl font-semibold md:text-3xl lg:text-4xl">Customers Feedback</h2>
                  <p class="text-base-content/80 text-xl">From career changes to dream jobs, here's how FlyonUI helped.
                  </p>
                  ...
                  <div class="carousel-slide">
                    <div
                      ...
                      <div class="card-body gap-5">
                        ...
                        <div class="flex items-center gap-3">
                          <div class="avatar">
                            <div class="size-10 rounded-full">
                              <img src="{{ asset('img/avatars/7.png') }}" alt="Craig Bator" />
                            </div>
                          </div>
                          <div>
                        ...
                        <!-- Content -->
                        <p class="text-base-content/80">Chef Marilyn’s signature curry is hands-down the best I’ve ever
                          had. The flavors are bold and unforgettable!”</p>
                      </div>
                    </div>
                  </div>
                  <!-- Slide 2 -->
                    ...
                    <div
                      ...
                      <div class="card-body gap-5">
                        ...
                        <div class="flex items-center gap-3">
                          <div class="avatar">
                            <div class="size-10 rounded-full">
                              <img src="{{ asset('img/avatars/2.png') }}" alt="Craig Bator" />
                            </div>
                          </div>
                          <div>
                        ...
                        <!-- Content -->
                        <p class="text-base-content/80">“Takahiro’s sushi is pure perfection. So fresh, delicate, and
                          beautifully presented — a five-star experience.”</p>
                      </div>
                    </div>
                  </div>
                  <!-- Slide 3 -->
                    ...
                    <div
                      ...
                      <div class="card-body gap-5">
                        ...
                        <div class="flex items-center gap-3">
                          <div class="avatar">
                            <div class="size-10 rounded-full">
                              <img src="{{ asset('img/avatars/3.png') }}" alt="Alexandra Lee" />
                            </div>
                          </div>
                          <div>
                        ...
                        <!-- Content -->
                        <p class="text-base-content/80">The ambiance is amazing, and the food is even better! The
                          grilled salmon was perfectly cooked. A must-try place!</p>
                      </div>
                    </div>
                  </div>
                  <!-- Slide 4 -->
                    ...
                    <div
                      ...
                      <div class="card-body gap-5">
                        ...
                        <div class="flex items-center gap-3">
                          <div class="avatar">
                            <div class="size-10 rounded-full">
                              <img src="{{ asset('img/avatars/12.png') }}" alt="Jason Wu" />
                            </div>
                          </div>
                          <div>
                        ...
                        <!-- Content -->
                        <p class="text-base-content/80">The service was exceptional. From the moment we walked in, the
                          staff made us feel like family.</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="bg-base-100 py-8 sm:py-16 lg:py-24">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div class="mb-12 text-center sm:mb-16 lg:mb-24">
                <h2 class="text-base-content mb-4 text-2xl font-semibold md:text-3xl lg:text-4xl">Get to Know Our
                  Amazing Team</h2>
                <p class="text-base-content/80 text-xl">Meet the Passionate Experts Behind Our Success and Learn More
                  About Their Roles .</p>
              </div>
              <!-- Team Members -->
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="card card-border hover:border-primary h-max shadow-none">
                  <figure class="bg-base-200 pt-10.5">
                    <img class="h-60 w-auto" src="{{ asset('img/chef-1.png') }}" alt="Cheyenne Workman" />
                  </figure>
                ...
                <div class="card card-border hover:border-primary h-max shadow-none">
                  <figure class="bg-base-200 pt-10.5">
                    <img class="h-60 w-auto" src="{{ asset('img/chef-2.png') }}" alt="Corey Rosser" />
                  </figure>
                  <div class="card-body gap-3 p-5">
                ...
                <div class="card card-border hover:border-primary h-max shadow-none">
                  <figure class="bg-base-200 pt-10.5">
                    <img class="h-60 w-auto" src="{{ asset('img/chef-3.png') }}" alt="Marilyn Westervelt" />
                  </figure>
                  <div class="card-body gap-3 p-5">
                ...
                <div class="card card-border hover:border-primary h-max shadow-none">
                  <figure class="bg-base-200 pt-10.5">
                    <img class="h-60 w-auto" src="{{ asset('img/chef-4.png') }}" alt="Ryan Passaquindici Arcand" />
                  </figure>
                  <div class="card-body gap-3 p-5">
          ...
          <div class="bg-base-200 relative h-full py-8 sm:py-16 lg:py-24">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div class="mb-12 space-y-4 text-wrap text-center sm:mb-16 lg:mb-24">
                <h2 class="text-base-content text-2xl font-semibold md:text-3xl lg:text-4xl">Frequently Asked Questions
                </h2>
                <p class="text-base-content/80 text-xl">Levarage artificial intelligence algorithms to provide users
                  with valuable insights</p>
              </div>
              <!-- Faq stepper -->
              <div class="relative w-full" id="faq-carousel-1"
                    ...
                    <div class="carousel-body h-full gap-12 opacity-0">
                      ...
                      <div class="carousel-slide m-2">
                        <div class="rounded-box hover:bg-base-100 hover:ring-primary p-4 text-center hover:ring">
                          ...
                          <p class="text-base-content/80">Yes, we do! You can place your order directly through our
                            website or via trusted food delivery platforms like Swiggy and Zomato. We ensure that all
                            dishes are packed with care and delivered promptly, so you can enjoy restaurant-quality food
                            in the comfort of your home.</p>
                          <div class="group mt-5 flex items-center justify-center gap-2">
                            <a class="link link-animated link-primary font-normal" href="#">Learn more</a>
                            <span
                      ...
                      <div class="carousel-slide m-2">
                        <div class="rounded-box hover:bg-base-100 hover:ring-primary p-4 text-center hover:ring">
                          ...
                          <p class="text-base-content/80">Booking a table is simple and quick. Just head over to our
                            reservation page, choose your preferred date and time, and confirm your booking in a few
                            clicks. You’ll receive a confirmation instantly. Prefer to speak with someone? You can also
                            call us directly.</p>
                          <div class="group mt-5 flex items-center justify-center gap-2">
                            <a class="link link-animated link-primary font-normal" href="#">Learn more</a>
                            <span
                      ...
                      <div class="carousel-slide m-2">
                        <div class="rounded-box hover:bg-base-100 hover:ring-primary p-4 text-center hover:ring">
                          ...
                          <p class="text-base-content/80">We’re open every day from 11:00 AM to 11:00 PM, offering both
                            lunch and dinner service. On weekends, we also serve a special brunch menu from 10:00 AM to
                            1:00 PM. Holiday hours may vary, so be sure to check our website or follow us on social
                            media for real-time updates and special announcements.</p>
                          <div class="group mt-5 flex items-center justify-center gap-2">
                            <a class="link link-animated link-primary font-normal" href="#">Learn more</a>
                            <span
                              class="icon-[tabler--arrow-narrow-right] text-primary size-5 shrink-0 transition-transform group-hover:-translate-x-1 rtl:rotate-180"></span>
                      ...
                      <div class="carousel-slide m-2">
                        <div class="rounded-box hover:bg-base-100 hover:ring-primary p-4 text-center hover:ring">
                          ...
                          <p class="text-base-content/80">We offer several payment options for your convenience,
                            including credit/debit card payments, bank transfers, and online payment gateways. We also
                            offer flexible payment plans for select travel packages.</p>
                          <div class="group mt-5 flex items-center justify-center gap-2">
                            <a class="link link-animated link-primary font-normal" href="#">Learn more</a>
                            <span
                              class="icon-[tabler--arrow-narrow-right] text-primary size-5 shrink-0 transition-transform group-hover:-translate-x-1 rtl:rotate-180"></span>
                      ...
                      <div class="carousel-slide m-2">
                        <div class="rounded-box hover:bg-base-100 hover:ring-primary p-4 text-center hover:ring">
                          ...
                          <p class="text-base-content/80">Yes, we do! We offer a variety of vegan dishes that are both
                            flavorful and satisfying. Our menu includes plant-based starters, mains, and even desserts.
                          </p>
                          <div class="group mt-5 flex items-center justify-center gap-2">
                            <a class="link link-animated link-primary font-normal" href="#">Learn more</a>
                            <span
      ...
      <footer>
        <div class="mx-auto max-w-7xl px-4 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8">
          <div class="flex items-center justify-between gap-3 max-md:flex-col">
            ...
            <nav class="flex items-center gap-6">
              <a class="link link-animated text-base-content/80 font-medium" href="#about-us">About</a>
              <a class="link link-animated text-base-content/80 font-medium" href="#services">Services</a>
              <a class="link link-animated text-base-content/80 font-medium" href="#team">Team</a>
              <a class="link link-animated text-base-content/80 font-medium" href="#faqs">FAQ</a>
            </nav>
        ...
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div class="text-base-content text-center text-base">
            &copy;2025
            <a class="text-primary" href="/">TIM IT SMANPUL</a>
            ,
            <br class="md:hidden" />
    ...
    <button
      ...
      id="scrollToTopBtn" aria-label="Circle Soft Icon Button"><span
        class="icon-[tabler--chevron-up] size-5 shrink-0"></span></button>
  </body>
</html>
