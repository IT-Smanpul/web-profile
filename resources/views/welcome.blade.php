          ...
          <div class="w-full justify-between lg:flex lg:items-center lg:gap-2">
            ...
            <div
              ...
              <div class="text-base-content flex gap-6 text-base max-lg:mt-4 max-lg:flex-col lg:items-center">
                <a class="hover:text-primary nav-link" href="#home">Beranda</a>
                <a class="hover:text-primary nav-link" href="#about-us">Tentang</a>
                <a class="hover:text-primary nav-link" href="#services">Fasilitas</a>
                <a class="hover:text-primary nav-link" href="#test">Test</a>
                <a class="hover:text-primary nav-link" href="#team">Staff</a>
                <a class="hover:text-primary nav-link" href="#faqs">Visi Misi</a>
              </div>
            </div>
