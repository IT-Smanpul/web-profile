<div class="space-y-6">
  <div class="flex flex-wrap items-center justify-between gap-4">
    ...
    <div class="flex items-center gap-2">
      <select class="select max-w-sm appearance-none" aria-label="select" wire:model.live="selected">
  ...
  <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3">
          ...
          <div class="card-actions mt-auto justify-end gap-2">
            <div class="tooltip">
              <a class="btn btn-sm btn-warning btn-soft"
                href="{{ route('guru-staff.edit', ['employee' => $employee->id]) }}">
            ...
            <div class="tooltip">
              <button class="btn btn-sm btn-error btn-soft"
                @click="$dispatch('delete-employee', { employee: '{{ $employee->id }}' })">
  ...
  <livewire:dashboard.guru-staff.delete />
