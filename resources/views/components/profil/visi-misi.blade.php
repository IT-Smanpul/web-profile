        ...
        <div class="grid gap-20 lg:grid-cols-2">
            <div class="relative">
                ...
                <p class="text-base-content/80 mt-6 text-xl leading-relaxed">
                    ...
                    <span class="text-base-content font-semibold">beriman</span>,
                    <span class="text-base-content font-semibold">berkarakter</span>,
                    <span class="text-base-content font-semibold">berprestasi</span>,
                    serta memiliki
                    <span class="text-base-content font-semibold">daya saing global</span>.
                </p>
            ...
            <div class="relative">
                ...
                <ul class="mt-8 space-y-6">
                    ...
                    <li class="flex gap-4">
                        <span class="mt-2 h-2 w-2 flex-shrink-0 rounded-full bg-green-500"></span>
                        <p class="text-base-content/80 leading-relaxed">
                            Menanamkan nilai karakter, integritas, tanggung jawab,
                            serta kepedulian sosial dalam kehidupan sekolah.
                        </p>
                    </li>
                    <li class="flex gap-4">
                        <span class="mt-2 h-2 w-2 flex-shrink-0 rounded-full bg-green-500"></span>
                        <p class="text-base-content/80 leading-relaxed">
                            ...
                            inklusif, dan kondusif bagi seluruh warga sekolah.
                        </p>
                    </li>
                </ul>
            </div>
