  ...
  <div class="relative">
    <div class="bg-base-100 relative mx-auto w-full rounded-3xl border p-8 shadow-sm">
      <div class="mb-8 space-y-2">
        <h2 class="text-xl font-semibold">Tambah Berita</h2>
        <p class="text-base-content/60 text-sm">
          Tambahkan berita dan informasi terbaru yang akan ditampilkan di website sekolah
        </p>
      </div>
      @if ($errors->any())
      ...
      @endif
      <form class="space-y-6" action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div>
          <label class="label">
            <span class="label-text font-medium">Judul Berita</span>
          </label>
          <input name="title" type="text" value="{{ old('title') }}" @class([
        ...
        <div>
          ...
          <div
            ...
            <img class="hidden h-full w-full object-cover" id="previewImg" alt="preview thumbnail" />
          </div>
